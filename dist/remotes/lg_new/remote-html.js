function getRemoteStyle_lg_new(config) {
   ...
   const base_url = `/config/www/community/w28-series-generic-remote-control-card/remotes/${template}`;
...
function getRemoteHtml_lg_new(config){return `
       <div class="container">
			...
			<div id="remote-control-${config.remote_template}">
				...
				<ul>
					<li id="list"  class="myButton-${config.remote_template}""><a href="#" title="list + 11"><span>+list</span></a></li>
